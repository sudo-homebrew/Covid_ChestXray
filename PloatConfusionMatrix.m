...
labels = renamecats(imds.Labels, {'No_findings'}, {'No findings'});
...
[X_No_findings, Y_No_findings, T_No_findings, AUC_No_findings] = perfcurve(labels, scores_No_findings, 'No findings');
...
l_No_findings = strcat('No findings        AUC=', string(AUC_No_findings));
